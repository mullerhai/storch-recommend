...
//  val selfAttens =  new ModuleList()
//  for(i <- 0 until numLayers by 1 ){ 
//    val atten = nn.MultiheadAttention(attenEmbedDim,numHeads,dropout=dropouts(0))
...
//      val cross_term_vec = atten(cross_term,cross_term,cross_term)
